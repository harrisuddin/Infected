...
class Animator {
    ...
    drawAI() {
        ...
        this._AI.forEach(AIElement => {
            ...
            context.drawImage(this.getPlayerImage(AIElement.image_src), AIElement.xPosition, AIElement.yPosition);
    ...
    rotate() {
        ...
        context.drawImage(this.getPlayerImage(this._player.image_src), this._player.xPosition, this._player.yPosition);

        context.restore();
    }

    getPlayerImage(imgSrc) {
        var img = new Image();
